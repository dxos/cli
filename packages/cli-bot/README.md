...
* `dx bot register` - Register a bot in Registry.
* `dx bot query` - Query bot in Registry.
...
To aid local development, bot factories can be made to run bot code directly from a bot directory, bypassing Registry/IPFS.
...
Bot binary packages are published to IPFS. Bot metadata is registered in Registry.
...
## Running Bots (via Registry/IPFS)
...
```bash
$ dx bot spawn --bot-name="dxn://dxos/bot/example" --topic 0955697f31e973503286ded7b426fa6725b9e6c9e06ba112f537467b0a1beb1e
...
```bash
  bot-factory Received command: {"botId":"dxn:bot:dxos.org/echo","__type_url":"dxos.protocol.bot.Spawn"} +3m
  bot-factory Spawn bot request for dxn:bot:dxos.org/echo +1ms
  ...
  bot-factory Spawned bot: {"pid":39899,"command":"/Users/egorgripasov/Projects/dxos/tests/botfactory/out/bots/QmV4MRDvTyrBfVVk7aXUxYtRWYWkv86pSYVME49XMHJ6xj/main.bin","args":[],"dxEnv":{"DX_BOT_IPC_SERVER":"bot-39752","DX_BOT_UID":"55c99bc68a6a35dd5216bebfde043ae07616d8a92a85a6fd3e91650ccccbfcef","DX_BOT_NAME":"bot:Store Pygmy Marmoset","DX_BOT_CWD":"/Users/egorgripasov/Projects/dxos/tests/botfactory/out/bots/QmV4MRDvTyrBfVVk7aXUxYtRWYWkv86pSYVME49XMHJ6xj/.bots/55c99bc68a6a35dd5216bebfde043ae07616d8a92a85a6fd3e91650ccccbfcef","DX_BOT_RESTARTED":false},"cwd":"/Users/egorgripasov/Projects/dxos/tests/botfactory/out/bots/QmV4MRDvTyrBfVVk7aXUxYtRWYWkv86pSYVME49XMHJ6xj/.bots/55c99bc68a6a35dd5216bebfde043ae07616d8a92a85a6fd3e91650ccccbfcef"} +20ms
...
```bash
$ dx bot factory status --topic=$(dx registry name resolve dxn://dxos/service/bot-factory/apollo1 | jq -r '.records[0].attributes.topic') | jq
{
  "started": true,
...
```bash
$ dx bot factory reset --hard --topic=$(dx registry name resolve dxn://dxos/service/bot-factory/apollo2 | jq -r '.records[0].attributes.topic')
```
