...
export const getProfileAndStorage = (storagePath: string | undefined, profilePath: string) => {
...
export const resetStorageForProfile = (storagePath: string | undefined, profilePath: string) => {
  if (!storagePath) {
